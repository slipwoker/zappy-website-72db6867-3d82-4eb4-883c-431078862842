document.addEventListener('DOMContentLoaded', function() {
  ...
  if (contactForm) {
    ...
    contactForm.addEventListener('blur', function(e) {
      const field = e.target;
      if (field.matches('input, textarea, select') && field.value.trim()) {
        const errorMessage = validateField(field);
        if (errorMessage) {
          showError(field, errorMessage);
        } else {
  ...
  if (animatedElements.length > 0) {
    function checkVisibility() {
      ...
      animatedElements.forEach(function(element) {
        ...
        const elementVisible = rect.top <= windowHeight * (1 - threshold) && rect.bottom >= 0;
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '72db6867-3d82-4eb4-883c-431078862842',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '72db6867-3d82-4eb4-883c-431078862842';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '72db6867-3d82-4eb4-883c-431078862842';
